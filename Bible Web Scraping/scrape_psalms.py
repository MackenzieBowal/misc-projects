...
# Scrape every Bible verse from the book of Psalms

alltext = []

for i in range(1, 151):

    url = 'https://biblegateway.com/passage/?search=Psalm%20{}&version=ESV'.format(i)
...
for sometext in alltext:
    if i > len(alltext)-10:
        ...
        continue
    i +=1
    csv_writer.writerow([sometext, 1])
